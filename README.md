...
The Arduino platform has limited C++ support. Depending on the board used, the toolchain might be outdated (2014) and limited to C++ 11. There isn't always C++ standard library availability, and AndroidSTL does not work with the Arduino IDE 2.0.
